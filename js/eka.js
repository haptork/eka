...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "logicStates", function() { return logicStates; });
...
function init(stages) {
  ...
  blocklyMediaPath = './blockly/media/';
  popButton = $("#popButton");
  popArea = $("#popUp");
  popClose = $("#popClose");
...
function resetLed(mv, st = mv.logicStates.unknown) {
...
function checkra() {
  successOrFail(Object(__WEBPACK_IMPORTED_MODULE_4__checkAnswer__["a" /* checkAnswer */])(stages.problems[mv.curStage()].states, mv.model.runStates));
}
